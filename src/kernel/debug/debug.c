        ...
        PRINTF_STATE_SPEC_:
            ...
            if (number)
            {
                ...
                else
                {
                    ...
                    case PRINTF_LENGTH_SHORT:
                    case PRINTF_LENGTH_DEFAULT:
                        debug_printf_unsigned(va_arg(args, unsigned int), radix);
                        break;

                    case PRINTF_LENGTH_LONG:
                        debug_printf_unsigned(va_arg(args, unsigned long), radix);
                        break;

                    case PRINTF_LENGTH_LONG_LONG:
                        debug_printf_unsigned(va_arg(args, unsigned long long), radix);
                        break;
                    }
                }
            }
...
static void debug_print_buffer(const char *msg, const void *buffer, uint32_t count)
{
